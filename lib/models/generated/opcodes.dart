...
class Opcodes {
  ...
  Opcodes clone() =>
      Opcodes(instructions: instructions.map((e) => e.clone()).toList());

  Opcodes copyWith({List<Instruction>? instructions}) => Opcodes(
...
class Instruction {
  ...
  factory Instruction.fromJson(Map<String, dynamic> json) => Instruction(
      ...
      opcodes: (json['opcodes'] as List? ?? [])
          .map((e) => Opcode.fromJson(e as Map<String, dynamic>))
          .toList());
...
class Opcode {
  ...
  Opcode clone() => Opcode(
      addressMode: addressMode, bytes: bytes, cycles: cycles, opcode: opcode);
  ...
  @override
  int get hashCode =>
      addressMode.hashCode ^ bytes.hashCode ^ cycles.hashCode ^ opcode.hashCode;
}
